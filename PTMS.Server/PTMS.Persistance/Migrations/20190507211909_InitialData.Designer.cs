...
namespace PTMS.Persistance.Migrations
{
    ...
    [Migration("20190507211909_InitialData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.BlockTypes", b =>
                {
                    b.Property<int>("BtId")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.Bs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.BsRoute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.BusStations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID");
                    ...
                    b.HasIndex("Number", "Rout")
                        .IsUnique()
                        .HasName("BUS_STATIONS_IDX1");

                    b.ToTable("BUS_STATIONS                   ");
                });
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.Granits", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID_");
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.ProjectRoute", b =>
                {
                    ...
                    b.HasIndex("ProjId", "RoutId")
                        .HasName("UNQ_PROJ_ROUTS_2");

                    b.ToTable("PROJ_ROUTS                     ");
                });

            modelBuilder.Entity("PTMS.Domain.Entities.Providers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID_");
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.Routs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID_");
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.DefaultPlans", b =>
                {
                    b.HasOne("PTMS.Domain.Entities.Routs", "Route")
                        .WithMany()
            ...
            modelBuilder.Entity("PTMS.Domain.Entities.Objects", b =>
                {
                    b.HasOne("PTMS.Domain.Entities.CarBrand")
                        .WithMany("Objects")
                        .HasForeignKey("CarBrandId");

                    b.HasOne("PTMS.Domain.Entities.Providers")
                        .WithMany("Objects")
